...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      className={cn(
        "shadow-foreground/5 z-50 mt-1 min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover p-1 shadow-md data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
        open
    ...
    <DropdownMenuPrimitive.Portal container={container} hostName={portalHost}>
      ...
      >
        <DropdownMenuPrimitive.Content
          className={cn(
            "shadow-foreground/5 z-50 min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover p-1 shadow-md web:data-[side=bottom]:slide-in-from-top-2 web:data-[side=left]:slide-in-from-right-2 web:data-[side=right]:slide-in-from-left-2 web:data-[side=top]:slide-in-from-bottom-2",
            open
              ? "web:animate-in web:fade-in-0 web:zoom-in-95"

        ...
        >
          <TextClassContext.Provider value="text-sm text-popover-foreground">
            <TooltipPrimitive.Content
              ...
              className={cn(
                "shadow-foreground/5 z-50 overflow-hidden rounded-md border border-border bg-popover px-3 py-1.5 shadow-md data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 web:animate-in web:fade-in-0 web:zoom-in-95",
                className,
              )}
              {...props}
            />

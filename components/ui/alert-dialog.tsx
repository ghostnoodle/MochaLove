...
function AlertDialogOverlayWeb({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      className={cn(
        "bg-overlay/80 absolute bottom-0 left-0 right-0 top-0 z-50 flex items-center justify-center p-2",
    ...
    <AlertDialogPortal container={container} hostName={portalHost}>
      <AlertDialogOverlay>
        <AlertDialogPrimitive.Content
          className={cn(
            "shadow-foreground/10 z-50 max-w-lg gap-4 rounded-lg border border-border bg-background p-6 shadow-lg web:duration-200",
            open

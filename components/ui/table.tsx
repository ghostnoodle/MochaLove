...
function TableFooter({
  ...
  return (
    <TablePrimitive.Footer
      className={cn("bg-muted/50 text-body [&>tr]:last:border-b-0", className)}
      {...props}
    />
  );
}
...
function TableRow({
  ...
  return (
    <TablePrimitive.Row
      className={cn(
        "web:hover:bg-muted/50 flex-row border-b border-border web:transition-colors web:data-[state=selected]:bg-muted",
        className,
      )}
      {...props}
    />

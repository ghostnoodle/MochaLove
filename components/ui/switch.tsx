  ...
  return (
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          "shadow-foreground/5 pointer-events-none block h-5 w-5 rounded-full bg-background shadow-md ring-0 transition-transform",
    ...
    >
      ...
      >
        <Animated.View style={animatedThumbStyle}>
          <SwitchPrimitives.Thumb
            className={"shadow-foreground/25 h-7 w-7 rounded-full bg-background shadow-md ring-0"}
          />
        </Animated.View>
      </SwitchPrimitives.Root>
    </Animated.View>
